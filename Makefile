...
pkgdatadir = $(datadir)/soccerwindow2
pkgincludedir = $(includedir)/soccerwindow2
pkglibdir = $(libdir)/soccerwindow2
pkglibexecdir = $(libexecdir)/soccerwindow2
...
CONFIG_CLEAN_FILES = Doxyfile soccerwindow2.spec
...
am__DIST_COMMON = $(srcdir)/Doxyfile.in $(srcdir)/Makefile.in \
	$(srcdir)/config.h.in $(srcdir)/soccerwindow2.spec.in \
...
ACLOCAL = ${SHELL} /home/blair/Downloads/soccerwindow2-5.1.1/config/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/blair/Downloads/soccerwindow2-5.1.1/config/missing autoconf
AUTOHEADER = ${SHELL} /home/blair/Downloads/soccerwindow2-5.1.1/config/missing autoheader
AUTOMAKE = ${SHELL} /home/blair/Downloads/soccerwindow2-5.1.1/config/missing automake-1.15
AWK = mawk
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/blair/Downloads/soccerwindow2-5.1.1/config/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = soccerwindow2
PACKAGE_BUGREPORT = akky@users.sourceforge.jp
PACKAGE_NAME = soccerwindow2
PACKAGE_STRING = soccerwindow2 5.1.1
PACKAGE_TARNAME = soccerwindow2
PACKAGE_URL = 
...
QT4_CPPFLAGS = 
QT4_CXXFLAGS = -DQT_SHARED -I/usr/include/qt4 -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I/usr/include/qt4/QtNetwork -I/usr/include/qt4 -I/usr/include/qt4/QtCore
...
QT4_LDFLAGS = -L/usr/X11R6/lib64
QT4_MOC = /usr/share/qt4/bin/moc
Qt4_CFLAGS = -DQT_SHARED -I/usr/include/qt4 -I/usr/include/qt4/QtCore
Qt4_LIBS = -lQtCore
RANLIB = ranlib
SET_MAKE = 
SHELL = /bin/bash
STRIP = 
VERSION = 5.1.1
abs_builddir = /home/blair/Downloads/soccerwindow2-5.1.1
abs_srcdir = /home/blair/Downloads/soccerwindow2-5.1.1
abs_top_builddir = /home/blair/Downloads/soccerwindow2-5.1.1
abs_top_srcdir = /home/blair/Downloads/soccerwindow2-5.1.1
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/blair/Downloads/soccerwindow2-5.1.1/config/install-sh
...
SUBDIRS = src
pkgdata_DATA = xpm/soccerwindow2.xpm
EXTRA_DIST = \
	bootstrap \
	soccerwindow2.pro \
	ChangeLog.qt \
...
soccerwindow2.spec: $(top_builddir)/config.status $(srcdir)/soccerwindow2.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
